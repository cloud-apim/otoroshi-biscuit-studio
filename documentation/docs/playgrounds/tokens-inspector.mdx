...
![Otoroshi Biscuit Studio Inspector playground](/img/tokens-inspector.svg)]
...
This graphical tool was designed to assist Eclipse Biscuit users in easily manipulating tokens and connecting with other tools included in our Otoroshi Biscuit Studio.
