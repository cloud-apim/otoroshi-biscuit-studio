...
* **[Biscuit Tokens Forge](/docs/entities/tokens_forge)**  
  A tool for generating new Biscuit tokens, either manually or based on predefined policies, making it easy to create tokens that meet your specific security needs.

### Supported Plugins in Otoroshi Biscuit Studio

* **[Verifiers Plugins](/docs/plugins/verifiers)**  
...
* **[Attenuators Plugins](/docs/plugins/attenuators)**  
