...
| `username` (if present) | The authenticated username of the requester. | `username("alice")` |
| `email` (if present) | The authenticated email of the requester. | `email("alice@example.com")` |
