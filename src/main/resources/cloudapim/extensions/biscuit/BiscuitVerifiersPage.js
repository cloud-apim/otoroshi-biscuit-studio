class BiscuitVerifiersPage extends Component {
  formSchema = {
    ...
    keypair_ref: {
        ...
        props: {
            ...
            valuesFrom: '/bo/api/proxy/apis/biscuit.extensions.cloud-apim.com/v1/biscuit-keypairs',
  ...
  client = BackOfficeServices.apisClient('biscuit.extensions.cloud-apim.com', 'v1', 'biscuit-verifiers');
  ...
  render() {
    return (
      React.createElement(Table, {
        ...
        itemUrl: (item) => `/bo/dashboard/extensions/cloud-apim/biscuit/verifiers/edit/${item.id}`,
        showActions: true,
        showLink: true,
        rowNavigation: true,
...
class BiscuitVerifierTester extends Component {
  ...
  render() {
    return [
       React.createElement('button', { type: 'button', className: 'btn btn-sm btn-success', onClick: this.send },
